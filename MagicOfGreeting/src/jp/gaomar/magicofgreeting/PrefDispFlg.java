...
public class PrefDispFlg extends DialogPreference{
	...
	public static final int DISP_MAX = 21;
	...
	private CheckBox chk_Disp13,chk_Disp14,chk_Disp15,chk_Disp16,chk_Disp17,chk_Disp18, chk_Disp19, chk_Disp20, chk_Disp21;
	...
	private void initUi(View view) {
		try {
			...
			chk_Disp19 = (CheckBox) view.findViewById(R.id.disp_19);
			chk_Disp20 = (CheckBox) view.findViewById(R.id.disp_20);
			chk_Disp21 = (CheckBox) view.findViewById(R.id.disp_21);
		} catch (Exception e) {
		}
	}
	...
	private void getFlg() {
		try {
			...
			chk_Disp19.setChecked(getVal(19));
			chk_Disp20.setChecked(getVal(20));
			chk_Disp21.setChecked(getVal(21));
		} catch (Exception e) {
		}
	...
	private void setFlg() {
		try {
			...
			|| chk_Disp17.isChecked() || chk_Disp18.isChecked() || chk_Disp19.isChecked() || chk_Disp20.isChecked()
			|| chk_Disp21.isChecked()) {
				...
				setVal(19, chk_Disp19.isChecked());
				setVal(20, chk_Disp20.isChecked());
				setVal(21, chk_Disp21.isChecked());
			} else {
