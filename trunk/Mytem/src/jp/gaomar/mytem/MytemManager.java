...
public class MytemManager {
	 ...
	 * @return
	 */
	public MytemMaster getMytemMaster(String janCode) throws SQLException,
			GaeException {
		// GAEに問い合わせる
	 ...
	 * @throws GaeException
	 */
	public void createMytemMaster(MytemMaster mytemMaster)
			throws GaeException {
		// GAEに登録
	 ...
	 * @throws SQLException
	 */
	public void createMytemHistory(
			String jancode,
			String itemname,
			MytemHistory mytemHistory) throws SQLException , GaeException{
		// SQLに登録する
