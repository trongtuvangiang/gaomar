...
import jp.gaomar.osakacitybus.fragment.TimetableFragment;
...
public class TimetableActivity extends FragmentActivity{
	...
	private String getNote(String html, int routeNo) {
		...
		Element contentClass = contentTimetable.select("table.timetable").get(routeNo-1).nextElementSibling();
		if (contentClass != null) {
			note = contentClass.text();
		}
		return note;
	}
}
